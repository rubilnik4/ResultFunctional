...
namespace ResultFunctionalXUnit.FunctionalExtensions.Sync.RExtensions.RValueTest
{
    ...
    /// </summary>
    public class RValueCurryListExtensionsTest
    {
        /// <summary>
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddOkStatus()
        {
            ...
            var resultOut = rValueFunc.RValueCurryList(resultArgument);
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddBadStatus()
        {
            var rValueFunc = CurryFunctions.IntCollectionToString.ToRValue();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddOkStatus()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, string>>();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddBadStatus()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, string>>();
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddOkStatus_TwoArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddBadStatus_TwoArguments()
        {
            var rValueFunc = CurryFunctions.AggregateCollectionTwoToString.ToRValue();
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRList<int>();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddOkStatus_TwoArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, string>>();
            var resultArgument = initialValue.ToRList();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddBadStatus_TwoArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, string>>();
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddOkStatus_ThreeArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddBadStatus_ThreeArguments()
        {
            var rValueFunc = CurryFunctions.AggregateCollectionThreeToString.ToRValue();
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRList<int>();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddOkStatus_ThreeArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, int, string>>();
            var resultArgument = initialValue.ToRList();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddBadStatus_ThreeArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, int, string>>();
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddOkStatus_FourArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddBadStatus_FourArguments()
        {
            var rValueFunc = CurryFunctions.AggregateCollectionFourToString.ToRValue();
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRList<int>();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddOkStatus_FourArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, int, int, string>>();
            var resultArgument = initialValue.ToRList();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddBadStatus_FourArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, int, int, string>>();
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddOkStatus_FiveArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_OkStatus_AddBadStatus_FiveArguments()
        {
            var rValueFunc = CurryFunctions.AggregateCollectionFiveToString.ToRValue();
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRList<int>();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddOkStatus_FiveArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, int, int, int, string>>();
            var resultArgument = initialValue.ToRList();
        ...
        /// </summary>
        [Fact]
        public void RValueCurryOkCollection_BadStatus_AddBadStatus_FiveArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = errorFunc.ToRValue<Func<IReadOnlyCollection<int>, int, int, int, int, string>>();
            var errorArgument = CreateErrorTest();
