...
namespace ResultFunctionalXUnit.FunctionalExtensions.Async.RExtensions.RValueTest
{
    ...
    public class ResultValueTryWhereBindAsyncExtensionsTest
    {
        ...
        public async Task ResultValueTryOkBindAsync_OkResult_ExceptionTry()
        {
            ...
            var resultValue = await numberResult.RValueTrySomeAwait(AsyncFunctions.DivisionAsync, Exceptions.ExceptionError());
        ...
        public async Task ResultValueTryOkBindAsyncFunc_OkResult_ExceptionTry()
        {
            ...
            var resultValue = await numberResult.RValueTrySomeAwait(AsyncFunctions.DivisionAsync, Exceptions.ExceptionFunc());
