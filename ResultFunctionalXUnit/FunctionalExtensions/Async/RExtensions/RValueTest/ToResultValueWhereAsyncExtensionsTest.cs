...
namespace ResultFunctionalXUnit.FunctionalExtensions.Async.RExtensions.RValueTest
{
    ...
    public class ToResultValueWhereAsyncAsyncExtensionsTest
    {
        ...
        public async Task ToResultValueWhereNullAsync_Ok()
        {
            ...
            var result = await testString.ToRValueEnsureOptionAsync(_ => true,
                                                                _ => errorInitial);
        ...
        public async Task ToResultValueWhereNullAsync_Bad()
        {
            ...
            var errorInitial = CreateErrorTestTask();
            var result = await testString.ToRValueEnsureOptionAsync(_ => false,
                                                           _ => errorInitial);
        ...
        public async Task ToResultValueWhereNullStructAsync_Ok()
        {
            int? testInt = 1;
            var errorInitial = CreateErrorTestTask();
            var result = await testInt.ToRValueEnsureOptionAsync(_ => true,
                                                        _ => errorInitial);
        ...
        public async Task ToResultValueWhereNullStructAsync_Bad()
        {
            int? testInt = 0;
            var errorInitial = CreateErrorTestTask();
            var result = await testInt.ToRValueEnsureOptionAsync(_ => false,
                                                        _ => errorInitial);
        ...
        public async Task ToResultValueWhereNullOkBadAsync_Ok()
        {
            ...
            var result = await testString.ToRValueEnsureWhereAsync(_ => true,
                                                                           Task.FromResult,
                                                                           _ => CreateErrorTestTask());
        ...
        public async Task ToResultValueWhereNullOkBadAsync_BadError()
        {
            ...
            var result = await testString.ToRValueEnsureWhereAsync(_ => false,
                                                            Task.FromResult,
                                                            _ => errorInitial);
        ...
        public async Task ToResultValueWhereNullOkBadStructAsync_Ok()
        {
            ...
            var result = await testInt.ToRValueEnsureWhereAsync(_ => true,
        ...
        public async Task ToResultValueWhereNullOkBadStructAsync_BadError()
        {
            ...
            var result = await testInt.ToRValueEnsureWhereAsync(_ => false,
                                                            CurryFunctions.IntToStringAsync,
                                                            _ => errorInitial);
