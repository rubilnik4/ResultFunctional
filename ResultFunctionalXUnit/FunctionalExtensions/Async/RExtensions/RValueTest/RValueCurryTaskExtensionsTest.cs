...
namespace ResultFunctionalXUnit.FunctionalExtensions.Async.RExtensions.RValueTest
{
    ...
    /// </summary>
    public class RValueCurryTaskExtensionsTest
    {
        /// <summary>
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddOkStatus()
        {
            ...
            var resultOut = await rValueFunc.RValueCurryTask(resultArgument);
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddBadStatus()
        {
            var rValueFunc = RValueFactory.SomeTask(CurryFunctions.IntToStringAsync);
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddOkStatus()
        {
            int initialValue = Numbers.Number;
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddBadStatus()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddOkStatus_TwoArguments()
        {
            int initialValue = Numbers.Number;
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddBadStatus_TwoArguments()
        {
            var rValueFunc = RValueFactory.SomeTask(CurryFunctions.AggregateTwoToStringAsync);
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRValue<int>();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddOkStatus_TwoArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddBadStatus_TwoArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddOkStatus_ThreeArguments()
        {
            int initialValue = Numbers.Number;
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddBadStatus_ThreeArguments()
        {
            var rValueFunc = RValueFactory.SomeTask(CurryFunctions.AggregateThreeToStringAsync);
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRValue<int>();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddOkStatus_ThreeArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddBadStatus_ThreeArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddOkStatus_FourArguments()
        {
            int initialValue = Numbers.Number;
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddBadStatus_FourArguments()
        {
            var rValueFunc = RValueFactory.SomeTask(CurryFunctions.AggregateFourToStringAsync);
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRValue<int>();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddOkStatus_FourArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddBadStatus_FourArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddOkStatus_FiveArguments()
        {
            int initialValue = Numbers.Number;
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_OkStatus_AddBadStatus_FiveArguments()
        {
            var rValueFunc = RValueFactory.SomeTask(CurryFunctions.AggregateFiveToStringAsync);
            var errorArgument = CreateErrorTest();
            var resultArgument = errorArgument.ToRValue<int>();
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddOkStatus_FiveArguments()
        {
            int initialValue = Numbers.Number;
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
        ...
        /// </summary>
        [Fact]
        public async Task RValueCurryOkTaskAsync_BadStatus_AddBadStatus_FiveArguments()
        {
            var errorFunc = CreateErrorTest();
            var rValueFunc = RValueFactory.NoneTask<Func<int, Task<string>>>(errorFunc);
            var errorArgument = CreateErrorTest();
