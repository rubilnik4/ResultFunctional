...
namespace ResultFunctionalXUnit.FunctionalExtensions.Async.ResultExtension.ResultValueTest
{
    ...
    /// </summary>
    public class ResultValueCurryCollectionBindAsyncExtensionsTest
    {
        /// <summary>
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddOkStatus()
        {
            ...
            var resultOut = await resultValueFunc.ResultValueCurryCollectionOkBindAsync(resultArgument);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddBadStatus()
        {
            var resultValueFunc = ResultValueFactory.CreateTaskResultValue(CurryFunctions.IntCollectionToString);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddOkStatus()
        {
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddBadStatus()
        {
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<IEnumerable<int>, string>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddOkStatus_TwoArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddBadStatus_TwoArguments()
        {
            var resultValueFunc = ResultValueFactory.CreateTaskResultValue(CurryFunctions.AggregateCollectionTwoToString);
            var errorArgument = CreateErrorTest();
            var resultArgument = ResultCollectionFactory.CreateTaskResultCollectionError<int>(errorArgument);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddOkStatus_TwoArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddBadStatus_TwoArguments()
        {
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<IEnumerable<int>, int, string>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddOkStatus_ThreeArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddBadStatus_ThreeArguments()
        {
            var resultValueFunc = ResultValueFactory.CreateTaskResultValue(CurryFunctions.AggregateCollectionThreeToString);
            var errorArgument = CreateErrorTest();
            var resultArgument = ResultCollectionFactory.CreateTaskResultCollectionError<int>(errorArgument);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddOkStatus_ThreeArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddBadStatus_ThreeArguments()
        {
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<IEnumerable<int>, int, int, string>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddOkStatus_FourArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddBadStatus_FourArguments()
        {
            var resultValueFunc = ResultValueFactory.CreateTaskResultValue(CurryFunctions.AggregateCollectionFourToString);
            var errorArgument = CreateErrorTest();
            var resultArgument = ResultCollectionFactory.CreateTaskResultCollectionError<int>(errorArgument);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddOkStatus_FourArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddBadStatus_FourArguments()
        {
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<IEnumerable<int>, int, int, int, string>>(errorFunc);
            var errorArgument = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddOkStatus_FiveArguments()
        {
            var initialValue = Collections.GetRangeNumber();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_OkStatus_AddBadStatus_FiveArguments()
        {
            var resultValueFunc = ResultValueFactory.CreateTaskResultValue(CurryFunctions.AggregateCollectionFiveToString);
            var errorArgument = CreateErrorTest();
            var resultArgument = ResultCollectionFactory.CreateTaskResultCollectionError<int>(errorArgument);
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddOkStatus_FiveArguments()
        {
            var initialValue = Collections.GetRangeNumber();
            var errorFunc = CreateErrorTest();
        ...
        /// </summary>
        [Fact]
        public async Task ResultValueCurryOkCollectionBindAsync_BadStatus_AddBadStatus_FiveArguments()
        {
            var errorFunc = CreateErrorTest();
            var resultValueFunc = ResultValueFactory.CreateTaskResultValueError<Func<IEnumerable<int>, int, int, int, int, string>>(errorFunc);
            var errorArgument = CreateErrorTest();
