...
Extension | Function type | Description
| ------------ | ------------ | ------------ |
`-` | Functor | Методы расширения типа функтор
`Bind` | Monada | Методы расширения типа монада
#### 4. Action type
...
| ------------ | ------------ | ------------ |
`Option` | Functor | Методы расширения типа функтор
`Where` | Monada | Методы расширения типа монада
`Match` | Monada | Методы расширения типа монада
`Some` | Monada | Методы расширения типа монада
`None` | Monada | Методы расширения типа монада
`Ensure` | Monada | Методы расширения типа монада
`Fold` | Monada | Методы расширения типа монада
### IRUnit extensions
### IRValue extensions
### IRList extensions
### Conclusion
