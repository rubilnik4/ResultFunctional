...
namespace ResultFunctional.FunctionalExtensions.Sync.RExtensions.Values
{
    ...
    /// </summary>
    public static class RValueCurryExtensions
    {
        /// <summary>
        ...
        public static IRValue<Func<TOut>> RValueCurrySome<TIn1, TOut>(this IRValue<Func<TIn1, TOut>> @this,
                                                                         IRValue<TIn1> arg1) 
            where TIn1 : notnull
            where TOut : notnull =>
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static IRValue<Func<TIn2, TOut>> RValueCurrySome<TIn1, TIn2, TOut>(this IRValue<Func<TIn1, TIn2, TOut>> @this,
                                                                                          IRValue<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TOut : notnull =>
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static IRValue<Func<TIn2, TIn3, TOut>> RValueCurrySome<TIn1, TIn2, TIn3, TOut>(this IRValue<Func<TIn1, TIn2, TIn3, TOut>> @this,
                                                                                                     IRValue<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static IRValue<Func<TIn2, TIn3, TIn4, TOut>> RValueCurrySome<TIn1, TIn2, TIn3, TIn4, TOut>(this IRValue<Func<TIn1, TIn2, TIn3, TIn4, TOut>> @this,
                                                                                                                  IRValue<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static IRValue<Func<TIn2, TIn3, TIn4, TIn5, TOut>> RValueCurrySome<TIn1, TIn2, TIn3, TIn4, TIn5, TOut>(this IRValue<Func<TIn1, TIn2, TIn3, TIn4, TIn5, TOut>> @this,
                                                                                                                             IRValue<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
