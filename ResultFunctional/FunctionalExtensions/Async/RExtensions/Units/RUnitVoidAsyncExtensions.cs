...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Units
{
    ...
    /// </summary>
    public static class RUnitVoidAsyncExtensions
    {
        /// <summary>
        ...
        public static async Task<IRUnit> RUnitVoidSomeAsync(this IRUnit @this, Func<Task> action) =>
            await @this.
        ...
        /// <param name="action">Action</param>
        /// <returns>Unchanged result error</returns>
        public static async Task<IRUnit> RUnitVoidNoneAsync(this IRUnit @this,
        ...
        /// <returns>Unchanged result error</returns>
        public static async Task<IRUnit> RUnitVoidMatchAsync(this IRUnit @this, Func<Task> actionSome,
        ...
        /// <returns>Unchanged result error</returns>
        public static async Task<IRUnit> RUnitVoidWhereAsync(this IRUnit @this, Func<bool> predicate, Func<Task> action) =>
            await @this.
