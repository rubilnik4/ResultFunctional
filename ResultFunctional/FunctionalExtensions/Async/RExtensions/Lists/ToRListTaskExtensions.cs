...
/// </summary>
public static class ToRListTaskExtensions
{
    /// <summary>
    ...
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IEnumerable<IRValue<TValue>>> @this)
    ...
    /// <param name="this">Incoming collection of result value</param>
    /// <returns>Outgoing result collection</returns>   
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IList<IRValue<TValue>>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
    ...
    /// <param name="this">Incoming collection of result value</param>
    /// <returns>Outgoing result collection</returns>   
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IReadOnlyCollection<IRValue<TValue>>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
    ...
    /// <returns>Outgoing result collection</returns>
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IRValue<IEnumerable<TValue>>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
    ...
    /// <param name="this">Incoming result value</param>
    /// <returns>Outgoing result collection</returns>   
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IRValue<IReadOnlyCollection<TValue>>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
    ...
    /// <param name="this">Incoming result value</param>
    /// <returns>Outgoing result collection</returns>
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IRValue<ReadOnlyCollection<TValue>>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
    ...
    /// <param name="this">Incoming result value</param>
    /// <returns>Outgoing result collection</returns>      
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IRValue<List<TValue>>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
    ...
    ///Converting task result collection to result error
    /// </summary>  
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this IEnumerable<Task<IRValue<TValue>>> @this)
        where TValue : notnull =>
    ...
    /// <returns>Outgoing result collection</returns>
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IReadOnlyCollection<IRError>> @this)
        where TValue : notnull =>
        await @this.
    ...
    /// <param name="this">Incoming errors</param>
    /// <returns>Outgoing result collection</returns>
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IRError> @this)
        where TValue : notnull =>
        await @this.
            MapTask(awaitedThis => awaitedThis.ToRList<TValue>());
    ...
    /// <returns>Outgoing result collection</returns>
    public static async Task<IRList<TValue>> ToRListTask<TValue>(this Task<IReadOnlyCollection<TValue>> @this)
        where TValue : notnull =>
        await @this.
        MapTask(awaitedThis => awaitedThis.ToRList());
}