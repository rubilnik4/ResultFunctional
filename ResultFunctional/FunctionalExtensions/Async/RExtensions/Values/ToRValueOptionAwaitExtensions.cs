...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    public static class ToRValueOptionAwaitExtensions
    {
        ...
        /// <param name="noneFunc">Error function if predicate <see langword="false"/></param>
        /// <returns>Outgoing result value</returns>
        public static async Task<IRValue<TValue>> ToRValueEnsureOptionAwait<TValue>(this Task<TValue?> @this,
                                                                                      Func<TValue, bool> predicate,
                                                                                      Func<TValue?, Task<IRError>> noneFunc)
            where TValue : class =>
            await @this.
            MapAwait(thisAwaited => thisAwaited.ToRValueEnsureOptionAsync(predicate, noneFunc));
        ...
        /// <param name="noneFunc">Error function if predicate <see langword="false"/></param>
        /// <returns>Outgoing result value</returns>
        public static async Task<IRValue<TValueOut>> ToRValueEnsureWhereAwait<TValueIn, TValueOut>(this Task<TValueIn?> @this,
            ...
            await @this.
            MapAwait(thisAwaited => thisAwaited.ToRValueEnsureWhereAsync(predicate, someFunc, noneFunc));
