...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    /// </summary>
    public static class RValueBindListOptionAsyncExtensions
    {
        /// <summary>
        ...
        public static async Task<IRList<TValueOut>> RValueBindListSomeAsync<TValueIn, TValueOut>(this IRValue<TValueIn> @this,
