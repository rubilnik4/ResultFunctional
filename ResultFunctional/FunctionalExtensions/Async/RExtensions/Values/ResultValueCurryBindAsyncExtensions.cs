...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    public static class ResultValueCurryBindAsyncExtensions
    {
        ...
        public static async Task<IRValue<Func<TOut>>> ResultValueCurryOkBindAsync<TIn1, TOut>(this Task<IRValue<Func<TIn1, TOut>>> @this,
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TOut>>> ResultValueCurryOkBindAsync<TIn1, TIn2, TOut>(this Task<IRValue<Func<TIn1, TIn2, TOut>>> @this,
                                                                                                          Task<IRValue<TIn1>> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TOut : notnull =>
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TIn3, TOut>>> ResultValueCurryOkBindAsync<TIn1, TIn2, TIn3, TOut>(this Task<IRValue<Func<TIn1, TIn2, TIn3, TOut>>> @this,
                                                                                                                      Task<IRValue<TIn1>> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TIn3, TIn4, TOut>>> ResultValueCurryOkBindAsync<TIn1, TIn2, TIn3, TIn4, TOut>(this Task<IRValue<Func<TIn1, TIn2, TIn3, TIn4, TOut>>> @this,
                                                                                                                                  Task<IRValue<TIn1>> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
        ...
        /// <param name="arg1">Result value argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TIn3, TIn4, TIn5, TOut>>> ResultValueCurryOkBindAsync<TIn1, TIn2, TIn3, TIn4, TIn5, TOut>(this Task<IRValue<Func<TIn1, TIn2, TIn3, TIn4, TIn5, TOut>>> @this,
                                                                                                                                              Task<IRValue<TIn1>> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
