...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    public static class ToRValueOptionTaskExtensions
    {
        ...
        /// <param name="noneFunc">Error function if predicate <see langword="false"/></param>
        /// <returns>Outgoing result value</returns>
        public static async Task<IRValue<TValue>> ToRValueEnsureOptionTask<TValue>(this Task<TValue?> @this,
                                                                                      Func<TValue, bool> predicate,
                                                                                      Func<TValue?, IRError> noneFunc)
            where TValue : class =>
            await @this.
        ...
        /// <param name="noneFunc">Error function if predicate <see langword="false"/></param>
        /// <returns>Outgoing result value</returns>
        public static async Task<IRValue<TValueOut>> ToRValueEnsureWhereTask<TValueIn, TValueOut>(this Task<TValueIn?> @this,
