...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    /// </summary>
    public static class RValueBindTryOptionAsyncExtensions
    {
        /// <summary>
        ...
        public static async Task<IRValue<TValueOut>> RValueBindTrySomeAsync<TValueIn, TValueOut>(this IRValue<TValueIn> @this,
        ...
        public static async Task<IRValue<TValueOut>> RValueBindTrySomeAsync<TValueIn, TValueOut>(this IRValue<TValueIn> @this,
            ...
            where TValueOut : notnull =>
            await @this.
                RValueBindSomeAsync(value => RValueBindTryAsync(() => func.Invoke(value), error));
    }
}