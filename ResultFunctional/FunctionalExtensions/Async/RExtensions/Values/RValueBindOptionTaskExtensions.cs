...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    /// </summary>
    public static class RValueBindOptionTaskExtensions
    {
        /// <summary>
        ...
        /// <returns>Outgoing result value</returns>          
        public static async Task<IRValue<TValueOut>> RValueBindWhereTask<TValueIn, TValueOut>(this Task<IRValue<TValueIn>> @this,
                                                                                              Func<TValueIn, bool> predicate,
                                                                                              Func<TValueIn, IRValue<TValueOut>> someFunc,
        ...
        /// <returns>Outgoing result value</returns>     
        public static async Task<IRValue<TValueOut>> RValueBindMatchTask<TValueIn, TValueOut>(this Task<IRValue<TValueIn>> @this,
                                                                                              Func<TValueIn, IRValue<TValueOut>> someFunc,
        ...
        /// <returns>Outgoing result value</returns> 
        public static async Task<IRValue<TValueOut>> RValueBindSomeTask<TValueIn, TValueOut>(this Task<IRValue<TValueIn>> @this,
                                                                                             Func<TValueIn, IRValue<TValueOut>> someFunc)
            where TValueIn : notnull
            where TValueOut : notnull =>
            await @this.
        ...
        /// <returns>Outgoing result value</returns>
        public static async Task<IRValue<TValue>> RValueBindNoneTask<TValue>(this Task<IRValue<TValue>> @this,
