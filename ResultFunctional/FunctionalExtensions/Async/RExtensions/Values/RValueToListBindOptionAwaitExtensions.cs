...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    /// </summary>
    public static class RValueToListBindOptionAwaitExtensions
    {
        /// <summary>
        ...
        public static async Task<IRList<TValueOut>> RValueToListBindSomeAwait<TValueIn, TValueOut>(this Task<IRValue<TValueIn>> @this,
                                                                                                 Func<TValueIn, Task<IRList<TValueOut>>> someFunc)
            where TValueIn : notnull
            where TValueOut : notnull =>
            await @this.
            MapAwait(thisAwaited => thisAwaited.RValueToListBindSomeAsync(someFunc));
    }
}