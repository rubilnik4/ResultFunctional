...
namespace ResultFunctional.FunctionalExtensions.Async.RExtensions.Values
{
    ...
    public static class ResultValueCurryCollectionTaskAsyncExtensions
    {
        ...
        public static async Task<IRValue<Func<TOut>>> ResultValueCurryCollectionOkTaskAsync<TIn1, TOut>(this Task<IRValue<Func<IReadOnlyCollection<TIn1>, TOut>>> @this,
                                                                                        IRList<TIn1> arg1)
            where TIn1 : notnull
            where TOut : notnull =>
            await @this.
            MapTask(thisAwaited => thisAwaited.RValueCurryListSome(arg1));
        ...
        /// <param name="arg1">Result collection argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TOut>>> ResultValueCurryCollectionOkTaskAsync<TIn1, TIn2, TOut>(this Task<IRValue<Func<IReadOnlyCollection<TIn1>, TIn2, TOut>>> @this,
                                                                                          IRList<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TOut : notnull =>
        ...
        /// <param name="arg1">Result collection argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TIn3, TOut>>> ResultValueCurryCollectionOkTaskAsync<TIn1, TIn2, TIn3, TOut>(this Task<IRValue<Func<IReadOnlyCollection<TIn1>, TIn2, TIn3, TOut>>> @this,
                                                                                                    IRList<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
        ...
        /// <param name="arg1">Result collection argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TIn3, TIn4, TOut>>> ResultValueCurryCollectionOkTaskAsync<TIn1, TIn2, TIn3, TIn4, TOut>(this Task<IRValue<Func<IReadOnlyCollection<TIn1>, TIn2, TIn3, TIn4, TOut>>> @this,
                                                                                                                  IRList<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
        ...
        /// <param name="arg1">Result collection argument</param>
        /// <returns>Result value higher order function</returns>
        public static async Task<IRValue<Func<TIn2, TIn3, TIn4, TIn5, TOut>>> ResultValueCurryCollectionOkTaskAsync<TIn1, TIn2, TIn3, TIn4, TIn5, TOut>(this Task<IRValue<Func<IReadOnlyCollection<TIn1>, TIn2, TIn3, TIn4, TIn5, TOut>>> @this,
                                                                                                                             IRList<TIn1> arg1)
            where TIn1 : notnull
            where TIn2 : notnull
            where TIn3 : notnull
